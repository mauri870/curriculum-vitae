...
\section*{work}
\begin{tabularcv}
    2016-Present   &   \worktitle{CTO / Software engineer}{FluxoTI / 3CPLUS Call Center Solutions}
                    \textbf{\textit{Remote / Full-time}}
                    \newline
		    Direct the transition to cloud based architecture (Kubernetes, Google Cloud), engineering and development of distributed systems using  Go, NodeJS, C, Python, PHP and Rust, implementation of AI based solutions with Tensorflow, project management with SCRUM, CI/CD with Gitlab and Kubernetes Cluster deploy and management.
                    \newline
