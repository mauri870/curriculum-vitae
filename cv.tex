...
\section*{work}
\begin{tabularcv}
    2016-Actual   &   \worktitle{Software engineer}{FluxoTI / 3CPLUS Call Center Solutions}
                    \newline 
                    Currently working with distributed arquitectures in GKE and: \newline
