...
\begin{tabularcv}
	2023-present   &   \worktitle{Postgraduate program in Data Science and Artificial Intelligence (expected 2024)}{Uninter, Brazil}
					...
					\begin{itemize}
						\item Fundamentals of Neuroscience Program (completed: The Electrical Properties of the Neuron, ongoing: Neurons and Networks, The Brain) - \textit{HarvardX}
						\item Integrated Neuroscience (completed: Synapses, ongoing: Pain, Reflexes and Locomotion, Motor Nervous System) - \textit{UFRGS}
    ...
    2017-2021   &   \worktitle{Bachelor of Technology in Information Technology with a focus on Systems Analysis and Design}{Uniftec, Brazil}
					\newline Related coursework:
					\begin{itemize}
						\item Introduction to Software Simulation in Combat and Armored warfare - \textit{UFRGS (Brazilian Army partnership)}
