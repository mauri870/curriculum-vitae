...
\section*{work}
\begin{tabularcv}
	2021   &   \worktitle{Associate / Senior Software Engineer}{Bucks App / Startup}
			...
			\begin{itemize}
				...
				\item Integrating with financial solutions such as Dwoola, Checkbook and Plaid.
			\end{itemize}
					\\[\vspacepar]
    ...
    2016-2019   &   \worktitle{Software engineer}{3CPLUS Call Center Solutions}
		    ...
		    \begin{itemize}
		    	...
		    	\item Spliting a larger and complex system into a distributed architecture composed of smaller microservices and docker containers, scalable horizontally.
		    	\item Creating REST, GRPC and Websocket APIs in Go, NodeJS.
...
\begin{tabularcv}
	2021   &   \worktitle{Initiation in combat and armored warfare simulation}{Brazilian Army / UFRGS}
					\\[\vspacepar]
