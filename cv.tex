...
\begin{tabularcv}
    2016-Actual   &   \worktitle{Software engineer}{FluxoTI}
                    ...
                    \textbf{Development}: Go, Python, Docker, Laravel, VueJS, MongoDB, PostgreSQL, Redis. \newline
...
\section*{operating systems}
	Just love Linux, I use Linux based operating systems since 2014 in a daily basis, currently with \href{https://github.com/mauri870/dot-files}{\color{maincolor}{Manjaro with i3wm \textcolor{red}{\faHeart}}}. Also have a thing for Plan9 and the acme editor.
