...
\begin{tabularcv}
	2024 - ongoing   &   \worktitle{Senior Software Engineer, OpenTelemetry}{Elastic}
		...
		\begin{itemize}
			...
			\item Participated in the migration of Beats to be OpenTelemetry Receivers.
			...
			\item Participated on Support Rotation, helping triaging and solving customer issues and vulnerability reports.
		\end{itemize}
				\\[\vspacepar]
...
\begin{tabularcv}
	...
	As an official member of the Go open source team, I’ve made substantial contributions to the language and its ecosystem.
