...
\begin{tabularcv}
    ...
    2016-2021   &   \worktitle{CTO / Lead Software Engineer}{3CPLUS - SAAS (communications)}
            ...
            \begin{itemize}
            	...
            	\item Independently built an open-source Kubernetes Health Check operator for automated status dashboards.
		    	...
		    	\item Developed Asterisk PABX modules in Rust/C to optimize telephony routines.
