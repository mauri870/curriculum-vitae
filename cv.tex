...
\begin{tabularcv}
	2022   &   \worktitle{Full Stack Software Engineer}{Meisterwerk}
			...
			\begin{itemize}
				\item Building APIs with Golang
				\item Developing and maintaining a mobile app with React Native
				\item Frontend software development with React and TailwindCSS
			\end{itemize}
					\\[\vspacepar]
